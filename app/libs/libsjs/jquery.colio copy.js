...
(function($, undefined) {
	...
	function Colio(list, settings){
		...
		if(this.settings.placement === 'after' ) {
			...
			//var filters = this.list.closest('.portfolio').find('.filter-menu');
...
//		var _addContentDiv = function(content,data){
//		
//			//var $newItems = $(content).find('body');
//			
//			//alert($newItems);
//			
//			// jq object
...
//			
//			//content = '<div>HELLLLOOO!</div>';
//			//console.log(content);
//			//alert(content);
//			
//			
//			
//			$('<div id="' + content_id + '" class="colio-content"><div class="modal-portfolio-header"><h2>Portfolio Title</h2></div><div class="modal-portfolio-content"></div></div>').append('Test').appendTo(self.markup.find('.colio-container'));
//			
//			
//			//$('.colio').css("cssText", "height: 0px !important;");
//			$('.colio-container #' + content_id + ' .modal-portfolio-content').load(data+' .page-holder', function() {
//				//alert();
//				//$('.colio').css("cssText", "height: 0;");
//				//$('.colio').animate({height:$('#'+content_id).height()});
//				
//				//returnID(content_id);
//			});
//			
//			//$('.colio-container #' + content_id).slideDown();
//				
//			// content callback
//				
//			
//			//function returnID(content_id) {				
...
//			}, 20);
			var html = '';
//			$('.colio').load(data+' .page-holder', function() {
//				
//			});
			setTimeout(function(){ 
			$.get(data, function(html) {
				callback.call(self, _addContentDiv(html,data));
			})
			}, 20);
//			.done(function(postData) {
//			
//				var $postContent = $(postData).filter('#page-content');
//				//alert($postContent.attr("id")+$postContent);
//				//console.log($postContent);
//				//$('.colio-container').append($postContent);
//				
//				setTimeout(function(){ 
//					callback.call(self, _addContentDiv(postData));
//				}, 20);
//			});
	...
	*/
	...
	Colio.prototype.expandViewport = function(content_id, adjust){
		...
		//this.markup.bind("load", function () { 
	...
	*/
	...
	Colio.prototype.getViewportHeight = function(content_id){
		...
		content_height = this.markup.find('#' + content_id).height();
	...
	*/
	...
	$.fn.colio = function(c) {
		...
		var s = $.extend({
			...
			onCollapse: function(){alert('2ho');},			// viewport collapse callback
			onContent: function(){
				alert('3ho');
